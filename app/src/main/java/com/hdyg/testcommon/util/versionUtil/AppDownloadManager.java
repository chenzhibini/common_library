package com.hdyg.testcommon.util.versionUtil;
...
public class AppDownloadManager {
    ...
    private String apkName = WordsUtil.getString(R.string.app_name)+".apk";
    ...
    //下载窗口
    private void showDownloadDialog(final String apkUrl, final String title, final String des) {
        AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
        builder.setTitle(R.string.sys_version_title2);
        final LayoutInflater inflater = LayoutInflater.from(mContext);
        View v = inflater.inflate(R.layout.sys_progress, null);
        mProgress = v.findViewById(R.id.progress);
        builder.setView(v);
        builder.setNegativeButton(R.string.sys_cancel,(dialog, which) -> dialog.dismiss());
        setUpdateListener((currentByte, totalByte) -> {
            int progress = (int) (((float) currentByte / totalByte) * 100);
