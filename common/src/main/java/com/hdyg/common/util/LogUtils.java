...
public class LogUtils {
     ...
     * @param tag            标签
     */
    public static void init(Context mContext, boolean logSwitch, boolean log2FileSwitch, char logFilter, String tag) {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            dir = mContext.getExternalCacheDir().getPath() + File.separator;
        } else {
            dir = mContext.getCacheDir().getPath() + File.separator;
        }
     ...
     * @return Builder对象
     */
    public static Builder getBuilder(Context mContext) {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
...
//        if (!FileUtils.createOrExistsFile(fullPath)) return;
        ...
        if (!fullFile.getParentFile().exists())
