...
/**
 * Created by CZB on 2018/3/2.
 * 设置系统状态栏字体颜色
 */

public class SysStyleUtil {
     ...
     * @param color 颜色
     * @param isDark 是否是黑色 true黑色 false白色
     */
    public static void setStatusBarLightMode(Activity activity, int color, boolean isDark) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            //判断是否为小米或魅族手机，如果是则将状态栏文字改为黑色
            if (MIUISetStatusBarLightMode(activity, isDark) || FlymeSetStatusBarLightMode(activity, isDark)) {
                //设置状态栏为指定颜色
                //api >= 21 api<23
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {// >=5.0 <6.0
                    //透明状态栏
