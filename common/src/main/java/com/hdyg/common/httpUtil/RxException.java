...
//        }
        if (e instanceof SocketException) {
            ...
            ex.message = CommonModule.getAppContext().getResources().getString(R.string.net_exception);
            return ex;
            ...
            ex.message = CommonModule.getAppContext().getResources().getString(R.string.null_exception);
            return ex;
        } else if (e instanceof javax.net.ssl.SSLHandshakeException) {
            ex = new RxException(e, ERROR.SSL_ERROR);
            ex.message = CommonModule.getAppContext().getResources().getString(R.string.ssl_exception);
            return ex;
        } else if (e instanceof ClassCastException) {
            ex = new RxException(e, ERROR.CAST_ERROR);
            ex.message = CommonModule.getAppContext().getResources().getString(R.string.type_exception);
            return ex;
            ...
            ex.message = CommonModule.getAppContext().getResources().getString(R.string.json_exception);
            return ex;
            ...
            ex.message = CommonModule.getAppContext().getResources().getString(R.string.no_exception);
            return ex;
        }
    }
