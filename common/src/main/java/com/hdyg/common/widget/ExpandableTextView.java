...
public class ExpandableTextView extends LinearLayout {
     ...
     * 文本文字颜色 全文/收起 文字颜色
     */
    private int mContentColor = getResources().getColor(R.color.white);
    private int mButtonColor = getResources().getColor(R.color.main_line);
     ...
     * 设置文本颜色和按钮颜色
     */
    public void setTextColor(int mContentColor,int mButtonColor){
    ...
    public void setText(CharSequence text) {
        ...
        mContentTextView.setTextColor(mContentColor);           // 设置文本颜色
        ...
        if (lineCount > mMaxLine) {
            ...
            mExpansionButton.setTextColor(mButtonColor);
